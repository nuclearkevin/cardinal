$(OPENMC_BUILDDIR)/Makefile: build_dagmc build_xdg | $(OPENMC_DIR)/CMakeLists.txt
	...
	-DOPENMC_FORCE_VENDORED_LIBS=$(USE_OPENMC_VENDORED_LIBS) \
	-DOPENMC_USE_XDG=$(ENABLE_XDG) \
